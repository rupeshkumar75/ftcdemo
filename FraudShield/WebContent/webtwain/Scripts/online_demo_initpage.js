...
function initMessageBox(bNeebBack) {
    ...
    objString += "<div id='DWTemessage' style='width:580px;height:80px; overflow:auto; background-color:#ffffff; border:1px #303030; border-style:solid; text-align:left; position:relative' >";
    objString += "</div></div>";
...
function initCustomScan() {
    ...
    ObjString += "<label for = 'ShowUIForWebcam'><input type='checkbox' id='ShowUIForWebcam' checked='checked' />Show Camera UI&nbsp;</label></li>";
    if (Dynamsoft.Lib.env.bWin) {
...
function setDefaultValue() {
    var vGray = document.getElementById("RGB");
    if(vGray)
        vGray.checked = true;
