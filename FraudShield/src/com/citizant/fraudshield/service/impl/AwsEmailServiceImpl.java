...
public class AwsEmailServiceImpl implements EmailService {
	...
	public boolean sendMail(String address, String title, String contents) {
        ...
        Content textBody = new Content().withData(contents);
        ...
        // Assemble the email.
        SendEmailRequest request = new SendEmailRequest().withSource(SystemConfig.SES_SENDER_EMAIL).withDestination(destination).withMessage(message);
